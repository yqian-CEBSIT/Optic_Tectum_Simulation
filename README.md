...
- `Figure3`
  ...
  - `Figure3/results/` is the default local output folder for generated replay tables.
- `Figure4`
...
- `Figure5`
  ...
  - `Figure5/results/` is the default local output folder for generated replay tables.
- `tools`
